...
HOSTCC       = gcc
HOSTCXX      = g++
HOSTCFLAGS   = -Wall -Wmissing-prototypes -Wstrict-prototypes -O1 -ggdb3 -fomit-frame-pointer -std=gnu89
HOSTCXXFLAGS = -O1 -ggdb3
...
KBUILD_CFLAGS	+= -Os -ggdb3 $(call cc-disable-warning,maybe-uninitialized,)
else
KBUILD_CFLAGS	+= -O1 -ggdb3
endif
